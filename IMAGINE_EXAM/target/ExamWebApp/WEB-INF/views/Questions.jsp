...
$(document).ready(function() {
  ...
  $('#theFormName').submit(function(event) {
      ...
      var json = { "theRadioGroupName" : theRadioGroupName};
...
<form:form action="${action}">
	<table>
		...
		<INPUT TYPE="hidden" NAME="questionId" VALUE=${userExamView.currentQuestion.questionId}></INPUT>
		<INPUT TYPE="hidden" NAME="numQuestions" VALUE=${userExamView.numQuestions}></INPUT>
		numQuestions
		</tr>
		
			<c:forEach items="${userExamView.currentQuestion.answers}" var="answer">
				<tr>
				<td>
					<INPUT TYPE="radio" NAME="answerId" VALUE=${answer.id}>${answer.answer}</INPUT>
				</td>
				</tr>
			</c:forEach>
...
<form:form action="${action}">
			...
			<c:if test="${i == userExamView.currentQuestion.questionId}">
				<INPUT TYPE="radio" NAME="theRadioGroupName" VALUE=${i} checked="checked">${i}</INPUT>
			</c:if>
